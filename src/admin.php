...
function pssp_add_admin_page() {
	...
	add_submenu_page( 'password-policy', __('User Lists', 'password-policy'), __('User Lists', 'password-policy'),'manage_options', 'pssp_display_page_user', 'pssp_display_page_user');
}
